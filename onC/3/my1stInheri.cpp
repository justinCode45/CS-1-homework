...
class SpecialDay : public DayofYear
{
public:
    SpecialDay(string _reason, int _month, int _day);
    void output();
    string getReason();
...
SpecialDay::SpecialDay(string _reason, int _month, int _day): DayofYear(_month, _day)
{
    reason = _reason;
}

void SpecialDay::output()
{
    cout << "month = " << this->getMonth() << ", day = " << this->getDay() << ", reason = " << reason << endl;
}

string SpecialDay::getReason()
{
    return reason;
}

void SpecialDay::setReason(string _reason)
{
    reason = _reason;
}